/*
 * Запустить рассмотренную в примере программу.
 */
...
public class BouncingBallSimpleEx1 extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new BouncingBallSimpleEx1());
                frame.pack();
